  ...
  return (
    <>
      ...
      >
        ...
        <DrawerContent>
          <DrawerCloseButton />
          <DrawerHeader fontSize={"24px"} color="black" borderBottomWidth="1px">
            Bag
          </DrawerHeader>
          <DrawerBody>
            ...
            <Box marginTop={"25px"}>
              ...
              <Text marginTop={"21px"} fontSize={"12.5px"}>
              ...
              <Center>
                <Text fontSize={"11px"} color={"#FF6781"}>
