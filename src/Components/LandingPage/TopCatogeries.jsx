  ...
  return (
    <>
      ...
      <Container marginTop="15px">
        <Center>
          <HStack spacing="0px">
            <Box style={{ cursor: "pointer", color: "red", width: "152px" }}>
              FACE CREAMS
            </Box>
            <Box>|</Box>
            <Box style={{ cursor: "pointer", width: "152px" }}>FACE SERUMS</Box>
            <Box>|</Box>
            <Box style={{ cursor: "pointer", width: "152px" }}>FACE WASHES</Box>
            <Box>|</Box>
            <Box style={{ cursor: "pointer", width: "152px" }}>FACE MASKS</Box>
          </HStack>
        </Center>
      </Container>
